    ...
    <section className="w-screen h-auto pb-24 sm:pb-32 overflow-auto">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base montserrat font-semibold text-pri">Shop smarter</h2>
          ...
          <p className="mt-6 text-lg text-gray-400 montserrat">
            Discover, shop, and save with our all-in-one ecommerce platform designed for your convenience.
          </p>
          <button className="mt-4 text-pri p-2 font-semibold border-pri border-2 rounded montserrat hover:bg-pri hover:text-black transition-colors duration-300">
            View All Products
          </button>
        </div>
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-2 lg:max-w-none lg:gap-y-16">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                ...
                <dd className="mt-2 text-gray-400 crimson-pro text-lg">{feature.description}</dd>
              </div>
            ))}
          </dl>
        </div>
